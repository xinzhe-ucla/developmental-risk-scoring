...
n=191
i=0
for DMR_bed in /u/home/h/hex002/project-cluo/BICAN/loop_DMR2/*.hypo_dmr_overlap.bed; do
    i=$((i+1))
    percent=$(( i * 100 / n ))
    filled=$(( percent / 5 ))
    empty=$(( 20 - filled ))
    ...
    base=${base%.*}
    hg19_DMR_bed="/u/scratch/l/lixinzhe/tmp-file/DMR/${base}.hg19.dmr.bed"
...
anno_out_dir='/u/home/l/lixinzhe/project-geschwind/result/ldsc/brain-dev/dmr2-annot/'
for hg19_DMR_bed in /u/scratch/l/lixinzhe/tmp-file/DMR/*.hg19.dmr.bed; do
...
conda activate ldsc
cd /u/home/l/lixinzhe/project-geschwind/software/ldsc/ldsc
annotation_dir="/u/home/l/lixinzhe/project-geschwind/result/ldsc/brain-dev/dmr2-annot/"
...
for hg19_DMR_bed in /u/scratch/l/lixinzhe/tmp-file/DMR/*.hg19.dmr.bed; do
    ...
    output="/u/home/l/lixinzhe/project-geschwind/result/ldsc/brain-dev/partitioned_heritability/dmr2/${base%.*}"
...
for hg19_DMR_bed in /u/scratch/l/lixinzhe/tmp-file/DMR/*.hg19.dmr.bed; do
    base=$(basename "$hg19_DMR_bed")
    annot_ldscore="${annotation_dir}${base%.*}."
    output="/u/home/l/lixinzhe/project-geschwind/result/ldsc/brain-dev/partitioned_heritability/dmr2/Schizophrenia_pardinas2018/${base%.*}"
...
for hg19_DMR_bed in /u/scratch/l/lixinzhe/tmp-file/DMR/*.hg19.dmr.bed; do
    base=$(basename "$hg19_DMR_bed")
    annot_ldscore="${annotation_dir}${base%.*}."
    output="/u/home/l/lixinzhe/project-geschwind/result/ldsc/brain-dev/partitioned_heritability/dmr2/ADHD_Demontis2018/${base%.*}"
