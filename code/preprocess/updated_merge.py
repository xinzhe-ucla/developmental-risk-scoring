...
# specify data:
samples_to_read = [
    "/u/project/cluo/heffel/BICAN3/DATA/mcg_Exc-merge_unnormalized_genebody_blacklist_allgenes_88932x49073.h5ad",
    "/u/project/cluo/heffel/BICAN3/DATA/mcg_Inh-merge_unnormalized_genebody_blacklist_allgenes_87121x49073.h5ad",
    "/u/project/cluo/heffel/BICAN3/DATA/mcg_Glial-merge_unnormalized_genebody_blacklist_allgenes_89495x49073.h5ad",
    "/u/project/cluo/heffel/BICAN3/DATA/mcg_NN-merge_unnormalized_genebody_blacklist_allgenes_21563x49073.h5ad"
    ]
...
for file_index, sample in tqdm(enumerate(samples_to_read)):
    ...
    # in case it isn't unique:
    adata.var_names_make_unique()
    
    # if it is the first file, save it for later:
    if file_index == 0:
        adata_combined = adata.copy()
    
    else:
        adata_combined = adata_combined.concatenate(adata)
    
    # append:
    loaded_file.append(sample)

# write h5ad:
adata_combined.write_h5ad("/u/project/cluo/lixinzhe/data/BICAN3/unnormalized_genebody_blacklist_allgenes_merged.h5ad")
