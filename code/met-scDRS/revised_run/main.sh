...
### with regress global methylation ###############################################################
# call met-scDRS:
submission_script="/u/home/l/lixinzhe/project-github/developmental-risk-scoring/code/met-scDRS/revised_run/submitter.sh"
...
for gs_file in ${input_gs_dir}KC_75_traits_split.gs*; do
    ...
    # compute scDRS:
    qsub ${submission_script} \
        "/u/project/cluo/lixinzhe/data/BICAN3/mcg_Exc-merge_unnormalized_genebody_blacklist_hgnc_88932x49073.h5ad" \
        "${gs_file}" \
        "mean_var_length" \
        "arcsine" \
        "inv_std" \
        '/u/home/l/lixinzhe/project-geschwind/result/met-scDRS/dev-revised/exc/diagnostics/' \
        '/u/home/l/lixinzhe/project-geschwind/result/met-scDRS/dev-revised/exc/' \
