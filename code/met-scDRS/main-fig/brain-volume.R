...
for (disease in imaging_trait){
    ...
    plot_df = meta[c(astro, odc, opc, drd1_eccentric_cell), ]
    plot_df$cell_type = factor(plot_df$adjusted_L3, levels = c('Glial_OPC', 'Glial_ODC', 'Glial_Astro',  'Inh_DRD1-eccentric-CASZ1'))
