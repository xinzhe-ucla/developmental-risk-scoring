...
for (disease in traits.interest){
    cor_collection[[disease]] = readRDS(paste0('/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/GO/cov/', disease, '_score_mch_correlation.rds'))
    go_collection[[disease]] = readRDS(paste0('/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/GO/cov/', disease, '_readable_go_results.rds'))
}
